  ...
  const navItems: {
    ...
    },
    {
      ...
      submenu: [
        ...
        { href: '/admin/debt-reports/debt-detail', label: 'Báo cáo chi tiết công nợ' },
        { href: '/admin/debt-reports/debt-by-period', label: 'Báo cáo chi tiết công nợ theo kỳ' },
        ...
        { href: '/admin/debt-reports/check-order', label: 'Báo cáo kiểm tra đơn hàng mua' },
        { href: '/admin/debt-reports/debt-customer', label: 'Báo cáo công nợ khách hàng' },
        { href: '/admin/debt-reports/debt-by-batch', label: 'Báo cáo công nợ theo đợt hàng' },
      ],
    },
  ];
