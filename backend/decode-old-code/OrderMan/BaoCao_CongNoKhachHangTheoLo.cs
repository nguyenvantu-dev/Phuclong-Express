...
public class BaoCao_CongNoKhachHangTheoLo : Page
{
	...
	private void LoadBaoCaoCongNoKhachHangTheoLoHang()
	{
		try
		{
			...
			if (array.Length == 3)
			{
				...
				if (array2.Length == 3)
				{
					...
					DataSet dataSet = dBConnect.BaoCaoCongNoKhachHangTheoLoHang(tuNgay, denNgay);
	...
	{
		LoadBaoCaoCongNoKhachHangTheoLoHang();
	}
