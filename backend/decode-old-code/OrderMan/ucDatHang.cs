...
public class ucDatHang : UserControl
{
	public string formID = "";

	protected ImageButton imgbtClose;
	...
	public void Luu(string UserName)
	{
		...
		if (dBConnect.ThemDatHangSimple(host, UserName, UserName, tbLinkHang.Text.Trim(), tbLinkHinh.Text.Trim(), tbMausac.Text.Trim(), tbSize.Text.Trim(), result, result2, drLoaitien.SelectedItem.Text.Trim(), tbGhichu.Text.Trim(), Convert.ToDouble(drLoaitien.SelectedValue), 0.0, HangKhoan: false, null, "", null))
		{
	...
	protected void imgbtClose_Click(object sender, ImageClickEventArgs e)
	{
		this.FormClosed(this, null);
	}
}
